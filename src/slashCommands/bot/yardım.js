const { ActionRowBuilder, StringSelectMenuBuilder, EmbedBuilder, ButtonBuilder, ButtonStyle, SlashCommandBuilder } = require("discord.js");
const settings = require("../../configs/settings.json")

module.exports = {
    data: new SlashCommandBuilder()
        .setName("yardım")
        .setDescription("Eirtis Yardım Komutlarını Gösterir"),
...
`)
        ...
        await interaction.reply({ components: [row, button1], embeds: [menu1] });
